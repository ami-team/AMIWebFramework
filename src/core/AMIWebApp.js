...
$AMINamespace('amiWebApp', /** @lends amiWebApp */ {
	...
	setupCtx: function(ctxDefaults, ctxOptionals, ctxSettings, ctx, defaults, optionals, settings)
	{
		/*------------------------------------------------------------------------------------------------------------*/
		...
		ctx.endpoint = amiCommand.endpoint;
	...
	start: function(settings)
	{
		this._globalDeferred.done(() => {
			...
			const [
				...
				'ami@lpsc.in2p3.fr',
				'http://cern.ch/ami/',
				this.originURL + '/template/AMI/Theme/blue.template',
				this.originURL + '/template/AMI/Fragment/locker.template',
