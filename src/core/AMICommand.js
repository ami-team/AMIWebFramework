...
$AMINamespace('amiCommand', /** @lends amiCommand */ {
	...
	addUser: function(user, pass, firstName, lastName, email, captchaHash, captchaText, attachCert, agree, settings)
	{
	...
	resetPass: function(user, captchaHash, captchaText, settings)
	{
