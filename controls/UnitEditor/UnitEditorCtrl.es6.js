...
import './assets/css/UnitEditorCtrl.css';

import twigUnitEditorCtrl from './assets/twig/UnitEditorCtrl.twig';
...
$AMIClass('UnitEditorCtrl', {
	...
	onReady: function()
	{
		...
		amiWebApp.appendHTML('body', twigUnitEditorCtrl).done(() => {
	...
	setup: function(selector)
	{
		...
		this.el.find('[data-unit-name]').each((index, item) => {
	...
	{
		if(el.attr('data-human-readable').trim().toLowerCase() === 'true')
		{
