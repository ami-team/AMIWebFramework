...
function __sql_rounded_rect(x, y, w, h, r, tl, tr, bl, br) {
...
//		this.updateEncoding();
	...
	updateFields: function() {
		...
		this.attr('.sql-table-top/d', __sql_rounded_rect(0, 0, width, 20, 10, true, true, false, false));
		this.attr('.sql-table-body/d', __sql_rounded_rect(0, 20, width, height, 3, false, false, true, true));
