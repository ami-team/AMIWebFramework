...
import twigResetPasswordApp from './assets/twig/ResetPasswordApp.twig';
...
$AMIClass('ResetPasswordApp', {
	...
	onReady: function(userdata)
	{
		...
		amiWebApp.replaceHTML('#ami_main_content', twigResetPasswordApp, {dict: dict}).done(() => {
			...
			$('#C12ED50C_4BF7_DAD3_C698_DE0DCBB3228C').submit((e) => {
					...
					window.resetPasswordApp.change(
	...
	change: function(user, oldPass, newPass)
	{
		...
		amiCommand.changePassword(user, oldPass, newPass).then((data, message) => {
