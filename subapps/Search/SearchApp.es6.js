...
import twigSearchApp from './assets/twig/SearchApp.twig';
...
$AMIClass('SearchApp', {
	...
	onReady: function(userdata)
	{
		...
		amiWebApp.loadResources([
			...
			this.searchCtor = data[0];

			this.tabCtrl = new data[1]();

			amiWebApp.replaceHTML('#ami_main_content', twigSearchApp).done(() => {

				this.tabCtrl.render('#FE8BB925_A267_F972_060E_CC9C70D0C6D2', {card: false}).done(() => {

					/*------------------------------------------------------------------------------------------------*/

					this.fragmentInterface = twigInterface;
